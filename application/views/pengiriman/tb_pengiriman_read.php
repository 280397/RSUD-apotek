                                        ...
                                        foreach ($pengiriman as $key) { ?>
                                            <tr>
                                                ...
                                                <!-- <td class="text-center">
                                                    <?php
                                                    if ($key->status == 1) { ?>
                                                        <form action="<?= site_url('Pengiriman/delete_detail') ?>" method="post">
                                                            <input type="hidden" name="id" />
                                                            <input type="hidden" name="no_spb" value="<?= $no_spb  ?>" />
                                                            <input type="hidden" name="id_ruang" value="<?= $ruang->id_ruang ?>" />
                                                            <input type="hidden" name="id_ruang_tujuan" value="<?= $ruang_tujuan->id  ?>" />
...
<!-- Modal ubah -->
<!-- <div class="modal fade" id="ubahpeng" tabindex="-1" role="dialog" aria-labelledby="ubahTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle">Form Ubah Pengiriman</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
